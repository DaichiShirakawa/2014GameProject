...
public class Star extends GameCharacterImpl implements GameCharacter {
	private static final int STAR_DEFAULT_SIZE = 20;

	private Star parentStar = null;
	...
	public Star makeChild(String caption, float scale, float hankei,
		...
		Star childStar = new Star(this, caption, scale, color, koten, jiten);
		childStar.setX(0);
	 ...
	 * parentStarから見た
	 */
	private static void setTranslate(Star star) {
