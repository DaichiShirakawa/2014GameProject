...
public class EDFEnemyBoss extends EDFEnemyBase {
	...
	public EDFEnemyBoss(ShootingScene parentScene, float bornAngle, LR lr) {
	...
	protected boolean updateProcess() {
		...
		if (FPSManager.totalFrame() % 900 == 0) {
			((EDFScene) getParentScene()).add(new EDFEnemyToki(
