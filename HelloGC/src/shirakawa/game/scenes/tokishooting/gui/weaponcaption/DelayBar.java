package shirakawa.game.scenes.tokishooting.gui.weaponcaption;

import java.util.ArrayList;
import java.util.List;

import shirakawa.game.classes.character.GameCharacterBasePoint;
import shirakawa.game.classes.character.TextCharacter;
import shirakawa.game.texture.Texture;
import shirakawa.game.texture.text.TextTextureMaker;
